...
class PaykuPayments(models.Model):
    transaction_id = models.CharField(unique=True, max_length=191)
    start = models.DateField()
    end = models.DateField()
    media = models.CharField(max_length=191)
    ...
    verification_key = models.CharField(max_length=191)
    authorization_code = models.CharField(max_length=191)
    last_4_digits = models.PositiveIntegerField(blank=True, null=True)
    installments = models.CharField(max_length=191, blank=True, null=True)
    card_type = models.CharField(max_length=191, blank=True, null=True)
    additional_parameters = models.CharField(max_length=191, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'payku_payments'


class PaykuTransactions(models.Model):
    id = models.CharField(unique=True, max_length=191)
    status = models.CharField(max_length=191, blank=True, null=True)
    order = models.CharField(unique=True, max_length=191, blank=True, null=True)
